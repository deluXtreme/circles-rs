...
The biggest remaining parity work is no longer the replenish planner, group convenience, or invitation-query foundation. The open gaps are the last higher-level invitation / referral facade edges, especially the optional referrals backend plus referral-code storage/composition planners, and wallet-specific execution flows outside the generic runner abstraction.
